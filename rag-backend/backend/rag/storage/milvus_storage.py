...
class ConnectedMilvus(Milvus):
    """Register the MilvusClient alias for ORM Collection compatibility."""
...
class MilvusStorage:
    ...
    def __init__(self, 
        ...
        self.alias = f"milvus_{self.collection_name}"
        ...
        self.alias = self.vector_store.alias

    def _ensure_connection(self):
        """Ensure pymilvus has a default connection for hybrid insert paths."""
        connect_kwargs = {
            "alias": self.alias,
            "uri": self.uri,
            "db_name": self.db_name,
